...
const TestimonialMobile = () => {
  const [TestimonialMobiles, setTestimonialMobiles] =
  ...
  const shuffleTestimonialMobiles = () => {
    setTestimonialMobiles(
      [...TestimonialMobiles].sort(() => Math.random() - 0.5)
    );
  };
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-4">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#f97316] flex flex-col sm:flex-row items-center text-center sm:text-start gap-3">
            <Star className="w-7 h-7 text-white" />
            What Our Members Say
          </h2>
          <button
            onClick={shuffleTestimonialMobiles}
